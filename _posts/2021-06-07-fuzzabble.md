...
![cfg](/assets/img/posts/cfg.png)

![callgraph](/assets/img/posts/callgraph.png)
...
![dominator](/assets/img/posts/dominator.png)
...
![example](/assets/img/posts/example1.png)
...
Let's also throw `[libyara.so](http://libyara.so)` against the plugin:

![example](/assets/img/posts/example2.png)
